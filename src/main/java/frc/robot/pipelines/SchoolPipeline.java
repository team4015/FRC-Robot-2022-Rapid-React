 ...
 * - Putting it through a RGB filter to isolate the reflective tape (the values for this haven't
...
public class SchoolPipeline extends PipelineTemplate {
	...
	public SchoolPipeline() {isRGB = true;}
	/**
	...
	public void process(Mat source0) {
		...
		double[] rgbThresholdRed = {0, 146};
		double[] rgbThresholdGreen = {147, 255.0};
		double[] rgbThresholdBlue = {138, 255.0};
